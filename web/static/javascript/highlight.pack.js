...
hljs.registerLanguage('tiger', function(hljs) {
  var TIGER_KEYWORDS = {
    keyword: 'array if then else while for to do let in end of break nil function var ' +
              'type import primitive class extends method new int bool char typedef string',
    built_in: 'print merge getchar'
  };
  return {
