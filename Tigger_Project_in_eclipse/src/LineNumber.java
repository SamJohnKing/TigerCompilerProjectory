...
private final static Color DEFAULT_BACKGROUND = new Color(12,34,56);
private final static Color DEFAULT_FOREGROUND = Color.cyan;
private final static Font DEFAULT_FONT = new Font("Consolas", Font.BOLD,12);
